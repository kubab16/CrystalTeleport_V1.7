...
public class Database {
    ...
    public Database() throws DatabaseConnectionException {
        ...
        try {
        	int tableCreate = 0;
        	tableCreate += CreateStatement().executeUpdate(CrystalHome.getTable());
        	tableCreate += CreateStatement().executeUpdate(CrystalHome.GetTableUser());
        	tableCreate += CreateStatement().executeUpdate(CrystalSpawn.getTable());
        	if (tableCreate > 0)
        	{
